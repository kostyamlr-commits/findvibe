...
export const CATEGORY_LIST = [
  ...
  { id: 'table-dining',   keywords: ['ceramic aesthetic mug minimalist','minimalist dinnerware set'] },
  { id: 'organization',   keywords: ['acrylic makeup organizer aesthetic','modular storage cube minimalist'] },
  { id: 'bedroom',        keywords: ['silk pillowcase aesthetic','aesthetic bedside lamp minimalist'] },
  { id: 'bathroom',       keywords: ['ceramic bath set minimalist','aesthetic shower curtain nordic'] },
  ...
  { id: 'spa',            keywords: ['soft bathrobe aesthetic','bath pillow minimalist'] },
  { id: 'kids-decor',     keywords: ['nordic nursery decor aesthetic','cute night light minimalist'] },
  { id: 'atmosphere',     keywords: ['led neon sign room aesthetic','string lights minimalist'] },
  { id: 'modern-kitchen', keywords: ['nordic tea set aesthetic','magnetic knife holder minimalist'] },
  { id: 'smart-storage',  keywords: ['vacuum storage bag aesthetic','under bed storage minimalist'] },
  { id: 'luxury-accents', keywords: ['gold finish decor aesthetic','marble style coaster minimalist'] },
]
